...
//   useEffect(() => {
//     // Fetch scheduled interviews for the interviewer here
//     const fetchScheduledInterviews = async () => {
//       try {
//         const response = await fetch("/user/view_interviewer_schedule", {
//           method: "GET",
//           headers: {
...
//     // Handle feedback modal display here
...
//       const response = await fetch("/user/provide_feedback", {
//         method: "POST",
//         headers: {
//           "Content-Type": "application/json",
//           authorization: "Bearer " + localStorage.getItem("token"),
...
//       if (response.ok) {
//         // Feedback submitted successfully, you can redirect or display a message
//         setFeedbackMessage("");
//         setSelectedInterview(null);
//         Window.location.reload();
//         navigate("/ProfessionalHistory"); // Redirect to the scheduled interviews page
//       } else {
...
//                       data-target="#feedbackModal" // Add data-target attribute
