...
function App() {
  ...
  return (
    <Router>
      <div>
        <div><Navbar /></div>
        {localStorage.getItem("role") === "student" && (window.location.pathname==="/ScheduledStudent" ||window.location.pathname==="/studentReview"||window.location.pathname==="/ActiveStudents"||window.location.pathname==="/makeRequest" ) && (
